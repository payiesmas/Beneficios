...
function Mostrartabla() { //muestra toda la base de datos
    ...
    Respuestaajax.open("POST", "../CN/mostrar.php", true);
...
function porpagina() { // muestra una cantidad de registros por el usuario
    ...
    Respuestaajax.open("POST", "../CN/Paginador.php", true);
    Respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    Respuestaajax.send(txtvalores);
};
...
$(function () {
    ...
    $("#BUSQUEDAGRAL").keyup(function () {
        ...
        Respuestaajax.open("POST", "../CN/Totalbd.php", true);
        Respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        Respuestaajax.send(txtvalores);
    });
    ...
    $("#txtcuentab").keyup(function () {
        ...
        Respuestaajax.open("POST", "../CN/bcuenta.php", true);
        Respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        Respuestaajax.send(txtvalores);
    });
    ...
    $("#txtnomb").keyup(function () {
        ...
        Respuestaajax.open("POST", "../CN/buscarnom.php", true);
        Respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        Respuestaajax.send(txtvalores);
    });
    $("#txttelb").keyup(function () {
        ...
        Respuestaajax.open("POST", "../CN/buscartel.php", true);
        Respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        Respuestaajax.send(txtvalores);
    });
    $("#txtemailb").keyup(function () {
        ...
        Respuestaajax.open("POST", "../CN/buscaremail.php", true);
        Respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        Respuestaajax.send(txtvalores);
    });
    ...
    $("#btnguardar").click(function () {
        ...
        var f = document.getElementById("txtarea").value;
        var g = document.getElementById("txtcomentarios").value;
        ...
        respuestaajax.open("POST", "../CN/guardar.php", true);
        respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    ...
    $("#btneditar").click(function () {
        ...
        if (a == "") {
            ...
            if (confirmacion == true) {
                ...
                respuestaajax.open("POST", "../CN/editar.php", true);
                respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                respuestaajax.send(informaciondeusuario);
            };
        };
...
function eliminarreg(oselim) {
    ...
    if (confirmacion == true) {
        ...
        respuestaajax.open("POST", "../CN/eliminar.php", true);
        respuestaajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        respuestaajax.send(informaciondeusuario);
    };
};
    ...
    if (a == "") {
        ...
        if (confirmacion == true) {
            ...
            respuestaajax.onreadystatechange = function () {
                if (respuestaajax.readyState == 4 && respuestaajax.status == 200) {
                    $(function () {
                        $("#alertaedit").show(500, function () {
                            $("#alertaedit").html(respuestaajax.responseText);
                        });
                        Mostrartabla();
                    });
